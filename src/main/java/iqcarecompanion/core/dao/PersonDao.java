...
public class PersonDao {
    ...
    public ResultSet getPersonRs(int primaryKey) throws SQLException{
        StringBuilder sbSql = new StringBuilder();
        sbSql.append("Declare @SymKey varchar(400)\n")
                .append("USE ").append(DB_NAME).append("\n")
                ...
                .append("FROM [").append(DB_NAME).append("].[dbo].mst_Patient AS Emp WHERE [Ptn_Pk] = ")
                .append(primaryKey)
    ...
    public Person getPerson(int primaryKey) throws SQLException {
        ...
        ResultSet rs = getPersonRs(primaryKey);
